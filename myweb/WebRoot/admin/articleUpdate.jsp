...
<body>
    ...
    <div id="content">
        <div id="wrap">
            <h1 style="font-weight:300">修改文章</h1>
            <form id="addArticle" action="updateArticle.do" method="post" target="article_preview" class="pure-form">
                <input type="hidden" name="id" value="<%=id %>">
                <div style="width:100%;min-width:500px;float:left;">
                    <input type="text" name="title" value="${article.title }" class="pure-input-1" style="margin-bottom:20px;" placeholder="在此输入标题" />
                    <textarea name="ckeditor" id="" cols="30" rows="10">${article.content }</textarea>
                </div>
                <div class="fabu">
                    <h2>修改</h2>
                    <div class="inside">
                    ...
                    <div class="clearfix" style="background-color:#f4f4f4;border-top:1px solid #a1a1a1;">
                        <input class="pure-button pure-button-primary" type="submit" style="float:right;margin:5px;" value="修改" />
                    </div>
                </div>
            </form>
        </div>
    ...
    <script>
        ...
        $("#article_preview").click(function() {
            ...
            $("#addArticle").submit();
            $("#addArticle").attr("action", "updateArticle.do");
            return false;
        })
    </script>
</body>
